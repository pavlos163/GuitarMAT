...
def eval():
    eval_objects = [get_eval(
        ...
        [52, 68, 98, 114, 137, 158, 179, 270, 314, 354, 397, 443, 527,
         ...
         1855, 1905, 1949, 1995, 2125]), get_eval(
        'dad2.mp3',
        ...
        [221, 291, 331, 403, 443, 516, 554, 664, 736, 774, 811, 845, 884,
         ...
         3503, 3540, 3580, 3618, 3655]), get_eval(
        'eam.mp3',
        ...
        [114, 130, 146, 168, 202, 220, 256, 275, 308, 326, 358, 378, 409, 428,
         ...
         1465, 1496, 1516, 1548, 1566, 1584, 1599, 1621, 1668, 1719]), get_eval(
        'nisiotiko.mp3',
