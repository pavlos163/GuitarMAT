...
def eval():
  ...
  scores.append(get_score('softkitty.mp3',
    ...
    ['D4'], ['B3'], ['B3'], ['C4'], ['C4'], ['A3'],
    ['A3'], ['G3'], ['A3'], ['G3']]))
  scores.append(get_score('echromatic.wav',
    ...
    [['E2'], ['F2'], ['F#2'], ['G2'], ['G#2'], ['A2'], ['A#2'],
    ['B2'], ['C3'], ['C#3'], ['D3'], ['D#3'], ['E3'], ['F3'], ['F#3'],
    ['G3'], ['G#3'], ['A3'], ['A#3'], ['B3'], ['C4'], ['C#4'], ['D4'],
    ['D#4'], ['E4'], ['F4'], ['F#4'], ['G4'], ['G#4'], ['G4'], ['F#4'],
    ['F4'], ['E4'], ['D#4'], ['D4'], ['C#4'], ['C4'], ['B3'], ['A#3'],
    ['A3'], ['G#3'], ['G3'], ['F#3'], ['F3'], ['E3'], ['D#3'], ['D3'],
    ['C#3'], ['C3'], ['B2'], ['A#2'], ['A2'], ['G#2'], ['G2'], ['F#2'],
    ['F2'], ['E2']]
    ))
  ...
  scores.append(get_score('fragkosirianinobass.mp3',
    ...
    ['F4'], ['G4'], ['F4'], ['E4'], ['F4'], ['E4'],
    ['D4'], ['A3'], ['D4']]))
  scores.append(get_score('dad.mp3',
  ...
  scores.append(get_score('dad2.mp3',
    ...
    ['A3'], ['D4']]))
  scores.append(get_score('nisiotiko.mp3',
    ...
    ['A3'], ['G3'], ['F3'], ['E3'], ['D3'], ['E3'], ['G2'], ['A2'], ['B2'],
    ['C3'], ['D3'], ['E3'], ['F3'], ['G3'], ['A3'], ['B3'], ['C4'], ['G2'],
    ['A2'], ['B2'], ['C3'], ['D3'], ['E3'], ['F3'], ['G3'], ['A3'], ['G3'],
    ['F3'], ['E3'], ['D3'], ['E3'], ['G3'], ['A3'], ['F3'], ['G3'], ['E3'],
    ['F3'], ['D3'], ['E3'], ['C3']]
    ))
  scores.append(get_score('prwinotsigaro.mp3',
    ...
    [['G4'], ['F#4'], ['E4'], ['F#4'], ['G4'], ['E4'], ['F#4'], ['G4'],
    ['F#4'], ['E4'], ['D4'], ['C4'], ['B3'], ['C4'], ['B3'], ['C4'],
    ['D4'], ['E4'], ['E4'], ['D4'], ['C4'], ['B3'], ['E2'], ['G4'],
    ['F#4'], ['E4'], ['F#4'], ['G4'], ['E4'], ['F#4'], ['G4'], ['F#4'],
    ['E4'], ['D4'], ['C4'], ['B3'], ['C4'], ['B3'], ['C4'], ['D4'],
    ['E4'], ['E4'], ['D4'], ['C4'], ['B3'], ['E2'], ['C4'], ['B3'],
    ['C4'], ['D4'], ['E4'], ['E4'], ['D4'], ['C4'], ['B3'], ['A3'],
    ['G3'], ['A3'], ['B3'], ['B4'], ['A#4'], ['B4'], ['E4'], ['G4'],
    ['F#4'], ['F#4'], ['E4'], ['E4'], ['E2']]
    ))
