...
def eval():
    scores = [get_score('C3G3.wav',
                        [156],
                        [['C3', 'G3']]), get_score('C3A3.wav',
                                                   [148],
                                                   [['C3', 'A3']]), get_score('C3B3.wav',
                                                                              [132],
                                                                              [['C3', 'B3']]), get_score('C3E3.wav',
                                                                                                         [196],
                                                                                                         [['C3',
                                                                                                           'E3']]),
              get_score('C3Asharp3.wav',
                        [184],
                        [['C3', 'A#3']]), get_score('C3D4.wav',
                                                    [203],
                                                    [['C3', 'D4']]), get_score('C3F3.wav',
                                                                               [233],
                                                                               [['C3', 'F3']]), get_score('C3C4.wav',
                                                                                                          [181],
                                                                                                          [['C3',
                                                                                                            'C4']]),
              get_score('C3Csharp4.wav',
                        [209],
                        [['C3', 'C#4']])]
